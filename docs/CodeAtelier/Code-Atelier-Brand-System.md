...
<link href="https://fonts.googleapis.com/css2?family=Cormorant+Garamond:ital,wght@0,300;0,400;0,500;0,600;0,700;1,400&family=EB+Garamond:ital,wght@0,400;0,500;1,400;1,500&family=JetBrains+Mono:wght@400&display=swap" rel="stylesheet">
```
...
:root {
  ...
  --ca-border-strong: rgba(184, 151, 106, 0.30);
  ...
  --ca-duration-slow: 1.0s;
  --ca-duration-reveal: 2.0s;
...
*Updated: Added ornate diamond sigil icon, macOS tray icon specs, Electron integration guidelines*
*Target platform: macOS Electron desktop application with React renderer*
