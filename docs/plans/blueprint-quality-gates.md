...
- [ ] **M8.2** Smoke gate (missing ⇒ ledger, not failure).
- [ ] **M8.3** Structural analysis (new dead code / import cycles ⇒ warnings).
- [ ] **M8.4** Ledger rollup + outcome mapping.
- [ ] **M8.5** Tests. Registered in both runners.
