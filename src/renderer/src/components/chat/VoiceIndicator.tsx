...
export default function VoiceIndicator({
  ...
  if (error) {
    return (
      <div className="flex items-center gap-2 px-3 py-1.5 mb-1 text-xs text-red-400 bg-red-500/10 rounded-lg border border-red-500/20">
        <Mic size={12} />
  ...
  // Recording state
  return (
    <div className="flex items-center gap-2 px-3 py-1.5 mb-1 text-xs text-red-300 bg-red-500/10 rounded-lg border border-red-500/20 animate-pulse">
