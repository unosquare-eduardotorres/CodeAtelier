...
export default function VoiceIndicator({
  ...
  if (error) {
    return (
      <div className="flex items-center gap-2 px-3 py-1.5 mb-1 text-xs text-danger bg-danger-muted rounded-lg border border-danger/20">
        <Mic size={12} />
  ...
  // Recording state
  return (
    <div className="flex items-center gap-2 px-3 py-1.5 mb-1 text-xs text-danger bg-danger-muted rounded-lg border border-danger/20 animate-pulse">
