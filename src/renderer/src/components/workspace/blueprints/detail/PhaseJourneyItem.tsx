...
export function PhaseJourneyItemContent({ phase, tasks }: PhaseJourneyItemContentProps): JSX.Element {
  ...
  switch (phase.phase) {
    case 'specify': return <SpecifyDeliverable phase={phase} duration={duration} />
    case 'clarify': return <ClarifyDeliverable phase={phase} duration={duration} />
    case 'plan': return <PlanDeliverable phase={phase} duration={duration} />
    case 'tasks': return <TasksDeliverable phase={phase} duration={duration} tasks={tasks} />
