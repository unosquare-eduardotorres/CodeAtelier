...
const FLOATING_ITEMS: FloatingItem[] = [
  ...
  { id: 'code',     type: 'icon', Icon: Code2,     colorClass: 'text-primary-text',  top: '8%',  left: '12%', size: 32, opacity: 0.35, duration: '7s',   delay: '0s',    floatDistance: '-22px', rotateStart: '-5deg',  rotateEnd: '10deg', driftX: '12px', animation: 'float-drift' },
  { id: 'terminal', type: 'icon', Icon: Terminal,   colorClass: 'text-accent',        top: '15%', left: '78%', size: 28, opacity: 0.30, duration: '5.5s', delay: '-1.5s', floatDistance: '-18px', rotateStart: '3deg',   rotateEnd: '-8deg', driftX: '-9px', animation: 'float-bounce' },
  { id: 'git',      type: 'icon', Icon: GitBranch,  colorClass: 'text-success',       top: '35%', left: '5%',  size: 26, opacity: 0.28, duration: '6.5s', delay: '-3s',   floatDistance: '-16px', rotateStart: '-10deg', rotateEnd: '5deg',  driftX: '14px', animation: 'float-drift' },
  { id: 'cpu',      type: 'icon', Icon: Cpu,        colorClass: 'text-primary-text',  top: '55%', left: '88%', size: 30, opacity: 0.32, duration: '8s',   delay: '-2s',   floatDistance: '-20px', rotateStart: '8deg',   rotateEnd: '-6deg', driftX: '-8px', animation: 'float-bounce' },
  { id: 'braces',   type: 'icon', Icon: Braces,     colorClass: 'text-accent',        top: '70%', left: '15%', size: 24, opacity: 0.25, duration: '6s',   delay: '-4s',   floatDistance: '-14px', rotateStart: '-3deg',  rotateEnd: '12deg', driftX: '10px', animation: 'float-drift' },
  { id: 'db',       type: 'icon', Icon: Database,   colorClass: 'text-warning',       top: '80%', left: '82%', size: 26, opacity: 0.30, duration: '7.5s', delay: '-1s',   floatDistance: '-17px', rotateStart: '6deg',   rotateEnd: '-4deg', driftX: '-11px',animation: 'float-bounce' },
  { id: 'layers',   type: 'icon', Icon: Layers,     colorClass: 'text-primary-text',  top: '25%', left: '92%', size: 24, opacity: 0.25, duration: '5s',   delay: '-2.5s', floatDistance: '-15px', rotateStart: '-7deg',  rotateEnd: '7deg',  driftX: '8px',  animation: 'float-drift' },
