// Ported from vendor: pixel-agents/webview-ui/src/hooks/useEditorKeyboard.ts
// Keyboard shortcuts for the office editor.
...
export function useEditorKeyboard(
  ...
  useEffect(() => {
    ...
    const handler = (e: KeyboardEvent): void => {
      ...
      if (e.key === 'Escape') {
        // Multi-stage Esc: deselect item -> close tool tab -> deselect placed -> close editor
