// Adapted from pixel-agents: webview-ui/src/constants.ts
// Local copy of constants used by the pixel-office engine and sprites.
...
export const SEAT_AVAILABLE_COLOR = 'rgba(80, 160, 60, 0.30)' // muted green
export const SEAT_BUSY_COLOR = 'rgba(180, 40, 40, 0.35)' // deep crimson
export const GRID_LINE_COLOR = 'rgba(200,180,140,0.08)' // warm parchment grid
