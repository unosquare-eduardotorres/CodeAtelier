// Adapted from pixel-agents: webview-ui/src/office/sprites/spriteData.ts
// PNG loader + hue-shift recoloring. VS Code postMessage removed.

import { adjustSprite } from '../colorize'
import type { Direction, FloorColor, SpriteData } from '../engine/types'
import { Direction as Dir } from '../engine/types'
...
/** Set pre-colored character sprites loaded from PNG assets. Call this when character sprites are loaded. */
