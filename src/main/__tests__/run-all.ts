...
const SERVICE_TEST_FILES: string[] = [
  ...
  '../services/__tests__/blueprint-prefix-size.test',
  '../services/__tests__/blueprint-workspace-docs.test',
  '../services/__tests__/blueprint-prompt-dedupe.test',
  ...
  '../services/__tests__/opencode-token-backstop.test',
  '../services/__tests__/blueprint-provider-model-attribution.test',
  ...
  '../services/__tests__/jira-issue-sync.test',
